  ...
  return (
    <>
      ...
      <div className="h-screen">
        <section className="z-10 flex w-screen flex-col items-center">
          <section className="relative w-screen max-w-[1920px] bg-white font-faktumTest font-[400]">
            <div>
          ...
          <div className=" z-10 mb-[110px]  w-full border-t-[1px] border-[#C0C0C0] sh:mb-[35px]"></div>
          <section className="z-10 flex h-[110px] w-full max-w-[1920px] justify-between px-[165px]">

      ...
      <article>
        ...
        <div className="flex-center relative top-[-45px] h-[49vw] justify-between">
          ...
          <div className="relative left-[11vw] top-[-6.5vw] w-[21vw]">
            <div className="absolute z-[2] animate-mainLogoAppear_lala font-pretendard text-[4.5vw] font-[300] leading-[5.5vw] opacity-0">
              {"4세대 필링\n라라필"}
            </div>
            <div className="absolute z-[2] animate-mainLogoDisappear_lala font-pretendard text-[4.5vw] font-[300] leading-[5.5vw]">
              {"벗기지 않고\n채워주는"}
            </div>
          </div>
      ...
      <article className="relative mt-[124px]">
        <div className="pl-[360px] pr-[441px]">
          <div className="flex-start-column gap-[80px]">
            ...
            <div className="flex-start-column gap-[30px] font-[400]">
